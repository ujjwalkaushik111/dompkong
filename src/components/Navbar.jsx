    ...
    <section className='Hero_bg overflow-hidden py-0 py-xl-5'>
        <Container className='position-relative'>
          <div className='d-flex justify-content-end pt-4'>
            <button className='BUTTON-Y'>cONNECT wALLET</button>
          </div>
          <div className='d-flex justify-content-center align-items-center gap-4 pt-2'>
            <img src={Twitter} alt="#" />
            <img src={Ship} alt="#" />
            <img src={Diamond} alt="#" />
            <img src={Discord} alt="#" />
          ...
          <div className='mt-5'>
            ...
            <h1 className='text_ffffff fs_xl ff_Azo_Sans_Uber fw-normal text-center'>WELCOME <span className='d-block'></span>TO <span className='text_F1C85D abs-dompkong'>DomPKong</span></h1>
            ...
            <div className="d-flex justify-content-end py-100">
