        ...
        <h2 className="text-center fw-normal fs_xl ff_Azo_Sans_Uber text_ffffff py-5" data-aos='zoom-in'data-aos-duration='3000' data-aos-delay='1000'>Roadmap</h2>
         <Row>
            <Col xl={4} className='d-flex align-items-center justify-content-center justify-content-xl-start position-relative'>
                <img data-aos='fade-right'data-aos-duration='3000'data-aos-delay='3000'src={Twopac} alt="#" />
                <img className='position-abs d-none d-xl-block'data-aos='zoom-in'data-aos-duration='3000'data-aos-delay='3000' src={RM_LINE} alt="#" />
            </Col>
            <Col xl={8} className='mt-5'>
                <div className='d-flex align-items-center mb-4 pb-2 position-relative Roadmap'>
                   ...
                   <div className='ps-5'data-aos='fade-left'data-aos-duration='3000'data-aos-delay='2000'>
